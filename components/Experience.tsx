        ...
        <section id="experience" className={styles.sectionTimeline}>
          ...
          <p className={styles.years}>
            <div>
              ...
              <p className="lg:pt-5 lg:text-lg sm:pt-2 sm:text-sm">
                ...
                a web app according to requirements of the client. Wrote well
                tested code in C# with ASP.NET for backend development and
              ...
              >
                <li>
                  <p>
                    ...
                    Developed a web app from scratch using ASP.NET Core using C#
                    for backend development and Angular 2+ (TypeScript) for the
                    front-end. The app was secured with Azure Active Directory
                    authentication allowing only users within the organization
                    access to the Portal. The portal is used daily by many users
                    in the organization.
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    JavaScript, which allows the authenticated user to search
                    for other users in his organization. The component
                    authenticated the users on the basis of the MSAL library
                ...
                <li>
                  <p>
                    ...
                    Worked closely with other developers to develop new features
                    on a web app according to the requirements provided by the
                    client. Performed unit testing on all the C# code that was
                    developed by me, to provide clean and tested features. The
                    web app uses ASP.NET Framework with C# for the backend and
                    CSHTML and JavaScript for the front-end. Also racked up some
                    experience of working with Azure Cosmos DB while working on
                    the project.
                  </p>
                </li>
              </ul>
          ...
          <p className={styles.years}>
            <div>
              ...
              <p className="lg:pt-5 lg:text-lg sm:pt-2 sm:text-sm">
                <strong className={styles.projectText}>Client Project: </strong>
                Collaborated with other developers to develop new features
                according to client requirements. Wrote well-tested code in C#
                and Angular JS for an ASP.NET Framwork Web App.
              </p>
            </div>
          </p>
        </section>
